...
/// 
/// </summary>
namespace Pandora.Infrastructure.Identity.Application.UI
{
    using Pandora.Infrastructure.Identity.Config;
    ...
    public class ExternalController : Controller
    {
        ...
        private async Task<(IdentityAppUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
